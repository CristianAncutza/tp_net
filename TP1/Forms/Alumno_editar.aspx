<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Alumno_editar.aspx.cs" Inherits="TP1.WebForm1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col col-4">
            ...
            <asp:Label ID="LblErrorFecNac" runat="server" ForeColor="red"  Text=""></asp:Label>
